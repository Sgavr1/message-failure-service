...
public class ReportUpdateDTO {
    ...
    public ReportUpdateDTO(long id, LocalDateTime timeBegin, LocalDateTime timeFinish, String description, long teamLeaderId, long operatorId, long breakdownTypeId) {
        this.id = id;
