...
public class SchedulerTeamLeaderLargeDTO {
    private long id;
    private LocalDateTime dateTimeWork;
    private int duration;

    public SchedulerTeamLeaderLargeDTO() {
    }

    public SchedulerTeamLeaderLargeDTO(long id, LocalDateTime dateTimeWork, int duration) {
        this.id = id;
